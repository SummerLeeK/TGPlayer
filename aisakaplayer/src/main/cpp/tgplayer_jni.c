...
static void TGPlayer_setDataSourceAndHeaders(JNIEnv *env, jobject thiz) {

}


static void TGPlayer_setVideoSurface(JNIEnv *env, jobject thiz) {
...
static void TGPlayer_seekTo(JNIEnv *env, jobject thiz, jint msec, jint mode) {
...
static jlong TGPlayer_native_setup(JNIEnv *env, jobject thiz) {
...
//        { "_setAndroidIOCallback",  "(Ltv/danmaku/ijk/media/player/misc/IAndroidIO;)V", (void *)TGPlayer_setAndroidIOCallback },
        ...
        {       "seekTo",             "(J)V",                      (void *) TGPlayer_seekTo},
        {       "_pause",             "()V",                       (void *) TGPlayer_pause},
        {       "isPlaying",          "()Z",                       (void *) TGPlayer_isPlaying},
        {       "getCurrentPosition", "()J",                       (void *) TGPlayer_getCurrentPosition},
        {       "getDuration",        "()J",                       (void *) TGPlayer_getDuration},
        {       "_release",           "()V",                       (void *) TGPlayer_release},
        {       "_reset",             "()V",                       (void *) TGPlayer_reset},
        {       "setVolume",          "(FF)V",                     (void *) TGPlayer_setVolume},
...
//        { "_getAudioCodecInfo",     "()Ljava/lang/String;",     (void *) TGPlayer_getAudioCodecInfo },
        {       "_getMediaMeta",      "()Landroid/os/Bundle;",     (void *) TGPlayer_getMediaMeta},
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *rev) {
    ...
    jclass tgplayer_clz = (*env)->FindClass(env,JNI_CLASS_TGPLAYER);

    (*env)->RegisterNatives(env,tgplayer_clz, g_methods, NELEM(g_methods));
